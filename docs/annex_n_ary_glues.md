...
### B. The Minimum Generators for Choice (The Sum Record)
...
### C. The Minimum Generators for Conjunction (The Product Record)
...
### F. The Hidden Third Monoid: `Compose`
