...
There are exactly two fundamental properties we can manipulate: **Choice** and **Conjunction**.

### A. The Minimum Generators for Choice (The Sum Record)
...
### B. The Minimum Generators for Conjunction (The Product Record)
...
### E. The Hidden Third Monoid: `Compose`
